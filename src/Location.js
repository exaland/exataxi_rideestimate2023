      ...
      <div className="my_location">
        ...
        <svg width="20" height="20" className="new_svg3">
          <circle
            ...
            fill="#FFCD00"
          />
          <text x="50%" y="50%" text-anchor="middle" stroke="#541871" dy=".3em">
            2
          </text>
        </svg>
      </div>
      ...
      <div className="main_section">
        ...
        <div className="bottom_container_data">
          <div className="bottom_section">
            <Button href="/searchlocation">
              <p>Where to?</p>
            </Button>
            <button className="select_time" onClick={handleClick}>
